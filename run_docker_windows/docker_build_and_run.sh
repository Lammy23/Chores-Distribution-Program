...
# How to run
# chmod +x run_docker_windows/docker_build_and_run.sh
# ./run_docker_windows/docker_build_and_run.sh
...
# docker push lammy23/weekly-chores-frontend:1.0
# docker push lammy23/weekly-chores-database:1.0
# docker push lammy23/weekly-chores-api:1.0
# docker push lammy23/weekly-chores-database-interface:1.0
